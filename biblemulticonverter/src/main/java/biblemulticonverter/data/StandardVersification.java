...
/**
 * Utility class representing the versification (number of verses of each
 * chapter) of a certain bible. The constant {@link #KJV}, referring to King
...
public class StandardVersification {
	public static final StandardVersification KJV = new StandardVersification(new int[][] {
			...
			{ 21, 49, 30, 37, 31, 28, 28, 27, 27, 21, 45, 13 }, { 11, 23, 5, 19, 15, 11, 16, 14, 17, 15, 12, 14, 16, 9 },
			...
			{ 24, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21, 14 }, { 24, 21, 29, 31, 26, 18 },
			{ 23, 22, 21, 32, 33, 24 }, { 30, 30, 21, 23 }, { 29, 23, 25, 18 }, { 10, 20, 13, 18, 28 }, { 12, 17, 18 },
			{ 20, 15, 16, 16, 25, 21 }, { 18, 26, 17, 22 }, { 16, 15, 15 }, { 25 },
			{ 14, 18, 19, 16, 14, 20, 28, 13, 28, 39, 40, 29, 25 }, { 27, 26, 18, 17, 20 }, { 25, 25, 22, 19, 14 },
			{ 21, 22, 18 }, { 10, 29, 24, 21, 21 }, { 13 }, { 14 }, { 25 },
	...
	public int[] getVerseCount(BookID book) {
		return verseCounts.get(book);
	}
}
