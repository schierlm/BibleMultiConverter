		...
		for (File file : files) {
			...
			try (BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream(file), StandardCharsets.UTF_8))) {
				...
				while ((line = br.readLine()) != null) {
					...
					Visitor<RuntimeException> vv = currVisitor.visitGrammarInformation(null, null, null, new String[] { rmac }, null, new int[] { idx }, new String[] {"lemma", "morphgnt:normalized-word"}, new String[] {parts[6], parts[5]});
